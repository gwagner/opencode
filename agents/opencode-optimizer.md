...
3. Prioritize broken or impossible workflows. Recommend minimal, file-level refactors: agents own role, boundary, workflow, and completion; skills own reusable procedure.
